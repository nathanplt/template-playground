...
int main() {
    /* push_back_t tests */
    {
        ...
        std::cout << "push_back_t TESTS PASS!" << '\n';
    }
    ...
    /* append_t tests */
    {
        ...
        static_assert(is_same_v<
            R1,
            std::tuple<int, int, double, int, char, double>
        >);
        ...
        static_assert(is_same_v<
            R2,
            meta_list<double, int, char, char>
        >);
    ...
    /* transform_t tests */
    {
        ...
        static_assert(is_same_v<
            R2,
            meta_list<int**, double*, char***, int****>
        >);

        std::cout << "transform_t TESTS PASS!" << '\n';
    }
